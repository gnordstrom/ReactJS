...
export default class NewChart extends Component {
	...
	addLabel(event) {
		// Need to prevent default because this will be attached to a form element.
		// Without this, the browser will reload
	...
	// The function to send the data to the reducer
	submitChart() {
